...
def generate_context_chunks(repo_owner: str, repo_name: str):
    ...
    for file_chunk in repository_chunks:
        ...
        for chunk in chunks:
            ...
            context_chunks.append(AnnotatedChunk(index=chunk_index, text=chunk_text, context=chunk_with_context, file_name=file_chunk.file_name, repo_name=file_chunk.repo_name, repo_owner=file_chunk.repo_owner))
